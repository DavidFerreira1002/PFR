#CODE FROM https://github.com/mannyray/KalmanFilter/blob/master/python_implementation/discrete_discrete/ddekf.py
...
"""
def ddekf( func, jacobian_func, dt_between_measurements, start_time, measurement_count,
        C, Q_root, R_root, P_0_root, x_0, measurements):
